...
for (x in 1:num_cluster) {
  ...
  check_sanity = FALSE
  ## diff expression \
  COVID.response <- FindMarkers(cosmic.covid.lrtd,ident.1 = paste(n,"_COVID-19", sep=""), assay = "RNA", slot = "data", ident.2 = paste(n,"_Pneumonia", sep=""), verbose = T, logfc.threshold = 0.25, min.pct = 0.1)
